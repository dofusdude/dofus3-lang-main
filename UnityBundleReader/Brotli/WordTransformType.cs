...
sealed class WordTransformType
{
    ...
    internal static int GetOmitFirst(int type) => type >= OmitFirst1 ? type - OmitFirst1 + 1 : 0;

    internal static int GetOmitLast(int type) => type <= OmitLast9 ? type - OmitLast1 + 1 : 0;
}
