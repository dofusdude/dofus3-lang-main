...
{
    static uint[] _mantissaTable = GenerateMantissaTable();
    static uint[] _exponentTable = GenerateExponentTable();
    static ushort[] _offsetTable = GenerateOffsetTable();
    static ushort[] _baseTable = GenerateBaseTable();
    static sbyte[] _shiftTable = GenerateShiftTable();
